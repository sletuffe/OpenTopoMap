...
This instance of OpenTopoMap-R can also be used in other applications.
...
Map's legend...
===============
Can be seen here [OTM-R's map legend](https://openmaps.fr/map-legend/opentopomap-legend.html)
